...
//  FRIEND_TEST(PDVaultTest, FUNC_MAID_Kademlia_FindNodes);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks1);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks2);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks3);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks4);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks5);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks6);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks7);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_StoreChunks8);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk1);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk2);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk3);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk4);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk5);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk6);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk7);
  FRIEND_TEST(PDVaultTest, FUNC_MAID_GetChunk8);
