...
enum ReturnCode {
  ...
  kSendChunkFailure = -7013,
  kTaskCancelledOffline = -7014,
  kFindNodesError = -7015,
  kFindNodesFailure = -7016,
  kFindNodesParseError = -7017,
  kFindValueError = -7018,
  kFindValueFailure = -7019,
  kFindValueParseError = -7020,
  kLoadChunkFailure = -7021,
  kLoadedChunkEmpty = -7022,
  kGetChunkFailure = -7023,
  kStoreIOUFailure = -7024,
  kSendIOUDoneFailure = -7025,
