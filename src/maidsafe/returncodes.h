...
enum ReturnCode {
  ...
  kLoadPacketCached = -7049,
  kCommonChecksumUndecided = -7050,
  kCommonChecksumMajority = -7051,
  kPacketUnknownType = -7052,
  kDirUnknownType = -7053,
  kLoadPacketFailure = -7054,
  kStoreManagerException = -7055,
  kFindAccountHoldersError = -7056,
  kRequestPendingConsensus = -7057,
  kRequestFailedConsensus = -7058,
  kRequestInsufficientResponses = -7059,
  kNoPublicKeyToCheck = -7060,
