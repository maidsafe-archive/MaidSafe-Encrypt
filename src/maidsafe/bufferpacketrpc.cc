...
void BufferPacketRpcsImpl::CreateBP(const kad::Contact &peer, bool local,
...
void BufferPacketRpcsImpl::ModifyBPInfo(const kad::Contact &peer, bool local,
...
void BufferPacketRpcsImpl::GetBPMessages(const kad::Contact &peer, bool local,
...
void BufferPacketRpcsImpl::AddBPMessage(const kad::Contact &peer, bool local,
...
void BufferPacketRpcsImpl::ContactInfo(const kad::Contact &peer, bool local,
