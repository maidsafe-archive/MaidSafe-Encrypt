...
#ifndef MAIDSAFE_LIFESTUFF_CLIENT_SAVE_TRANSFER_SETTINGS_THREAD_H_
#define MAIDSAFE_LIFESTUFF_CLIENT_SAVE_TRANSFER_SETTINGS_THREAD_H_
...
*/
class SaveTransferSettingsThread : public WorkerThread {
  Q_OBJECT
 public:
  SaveTransferSettingsThread(QHash<QString, QString> theHash,
                             QObject* parent = 0);
  virtual ~SaveTransferSettingsThread();
