    ...
    , message_( message )
{
    if ( !message_.isEmpty() )
    {
        ...
        {
            qWarning() << "ignoring presence message for state" << int(state);
            message_ = QString();
        }
    }
}
...
QString Presence::message() const
{
    ...
    case AVAILABLE:
        return QApplication::translate( "Presence", "Available" );

    case IDLE:
        return QApplication::translate( "Presence", "Idle" );

    case BUSY:
        return QApplication::translate( "Presence", "Busy" );

    case UNAVAILABLE:
        return QApplication::translate( "Presence", "Unavailable" );

    default:
        qWarning() << "bad presence" << int( state_ );
        return QApplication::translate( "Presence", "Unknown" );
    }
