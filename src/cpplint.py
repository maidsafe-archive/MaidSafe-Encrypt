  ...
  def RepositoryName(self):
    ...
    if os.path.exists(fullname):
      ...
      if os.path.exists(os.path.join(project_dir, ".svn")):
        ...
        # Edited by Fraser 04/03/09 - changed '+ 1' to '+ 11' below to remove
        # 'trunk/src/' from path.  We're not going to change that surely?
        # We really aren't... are we?... Not this week anyway??!
        return fullname[len(prefix) + 11:]
