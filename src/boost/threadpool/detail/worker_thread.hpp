...
namespace detail {
  ...
  /*! \brief Thread pool worker.
  *
  * A worker_thread represents a thread of execution. The worker is attached to
  * a thread pool and processes tasks of that pool. The lifetime of the worker
  * and its internal boost::thread is managed automatically.
  *
  ...
  */
  ...
  class worker_thread : public enable_shared_from_this< worker_thread<Pool> > {
  public:
