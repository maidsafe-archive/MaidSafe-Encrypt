...
void protobuf_BuildDesc_general_5fmessages_2eproto_AssignGlobalDescriptors(
...
class GeneralResponse : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void protobuf_BuildDesc_general_5fmessages_2eproto_AssignGlobalDescriptors(
