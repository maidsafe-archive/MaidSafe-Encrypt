...
IF(MSVC)
  ...
  ELSE()
    SET(GTEST_LIBPATH_SUFFIX msvc/gtest/Release)
  ENDIF()
ELSE()
  SET(GTEST_LIBPATH_SUFFIX lib lib64)
ENDIF()

FIND_LIBRARY(Gtest_LIBRARY_RELEASE NAMES gtest.a gtest PATHS ${GTEST_LIB_DIR} ${GTEST_ROOT_DIR} PATH_SUFFIXES ${GTEST_LIBPATH_SUFFIX})
IF(MSVC)
  IF(CMAKE_CL_64)
    SET(GTEST_LIBPATH_SUFFIX msvc/x64/Debug)
  ELSE()
    SET(GTEST_LIBPATH_SUFFIX msvc/gtest/Debug)
  ENDIF()
  FIND_LIBRARY(Gtest_LIBRARY_DEBUG NAMES gtestd gtest PATHS ${GTEST_LIB_DIR} ${GTEST_ROOT_DIR} PATH_SUFFIXES ${GTEST_LIBPATH_SUFFIX})
ENDIF()
