...
IF(INSTALLBUILDER_ROOT_DIR)
  ...
  ELSE()
    SET(INSTALLBUILDER_ROOT_DIR ${INSTALLBUILDER_ROOT_DIR} CACHE PATH "Path to BitRock InstallBuilder root directory" FORCE)
  ENDIF()
ELSEIF(DEFAULT_THIRD_PARTY_ROOT)
  FIND_THIRD_PARTY_PROJECT(INSTALLBUILDER_ROOT_DIR "BitRock InstallBuilder Professional" $ENV{PROGRAMFILES})
  IF(INSTALLBUILDER_ROOT_DIR_CACHED)
    SET(INSTALLBUILDER_ROOT_DIR ${INSTALLBUILDER_ROOT_DIR_CACHED})
  ENDIF()
ENDIF()
...
IF(INSTALLBUILDER_REQUIRED)
  ...
  IF(NOT InstallBuilder_BUILDER_EXE)
    ...
    SET(ERROR_MESSAGE "${ERROR_MESSAGE}${ERROR_MESSAGE_CMAKE_PATH} -DINSTALLBUILDER_ROOT_DIR=<Path to BitRock InstallBuilder root directory>\n\n")
    SET(ERROR_MESSAGE "${ERROR_MESSAGE}If InstallBuilder is not required, run:\n")
    SET(ERROR_MESSAGE "${ERROR_MESSAGE}${ERROR_MESSAGE_CMAKE_PATH} -DINSTALLBUILDER_ROOT_DIR=NA\n\n")
