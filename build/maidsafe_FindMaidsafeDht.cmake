...
IF(MAIDSAFE_DHT_INC_DIR)
  SET(MAIDSAFE_DHT_INC_DIR ${MAIDSAFE_DHT_INC_DIR} CACHE PATH "Path to maidsafe-dht include directory" FORCE)
ENDIF()
FIND_PATH(maidsafe_dht_INCLUDE_DIR maidsafe-dht/maidsafe-dht.h PATHS ${MAIDSAFE_DHT_INC_DIR} ${MAIDSAFE_DHT_ROOT_DIR}/build/Win_MSVC/include ${MAIDSAFE_DHT_ROOT_DIR}/include)
IF(NOT maidsafe_dht_INCLUDE_DIR)
  SET(ERROR_MESSAGE "\nCould not find maidsafe-dht.h\n")
...
FILE(STRINGS ${maidsafe_dht_INCLUDE_DIR}/maidsafe-dht/common/version.h VERSION_LINE REGEX "MAIDSAFE_DHT_VERSION")
STRING(REPLACE "#define MAIDSAFE_DHT_VERSION " "" INSTALLED_DHT_VERSION ${VERSION_LINE})
FIND_FILE(VERSION_DOT_H version.h ${${PROJECT_NAME}_ROOT}/src/maidsafe-encrypt)
FILE(STRINGS ${VERSION_DOT_H} VERSION_LINE REGEX "#define THIS_MAIDSAFE_DHT_VERSION")
