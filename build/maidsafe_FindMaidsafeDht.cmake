...
IF(MSVC)
  IF(CMAKE_CL_64)
    SET(DHT_LIBPATH_SUFFIX build/Win_MSVC/bin/x64/Release build/Win_MSVC/bin/x64/Debug build/Win_MSVC/bin/x64/RelWithDebInfo build/Win_MSVC/bin/x64/MinSizeRel)
  ELSE()
    SET(DHT_LIBPATH_SUFFIX build/Win_MSVC/bin/win32/Release build/Win_MSVC/bin/win32/Debug build/Win_MSVC/bin/win32/RelWithDebInfo build/Win_MSVC/bin/win32/MinSizeRel)
  ENDIF()
...
ENDIF()
FIND_PATH(maidsafe_dht_INCLUDE_DIR maidsafe/maidsafe-dht_config.h PATHS ${MAIDSAFE_DHT_INC_DIR} ${MAIDSAFE_DHT_ROOT_DIR}/build/Win_MSVC/include)
