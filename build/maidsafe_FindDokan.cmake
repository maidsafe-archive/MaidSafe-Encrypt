...
IF(DOKAN_LIB_DIR)
  SET(DOKAN_LIB_DIR ${DOKAN_LIB_DIR} CACHE PATH "Path to Dokan library directory" FORCE)
ENDIF()
...
IF(NOT Dokan_LIBRARY)
  ...
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}${ERROR_MESSAGE_CMAKE_PATH} -DDOKAN_LIB_DIR=<Path to Dokan lib directory>")
...
IF(DOKAN_INC_DIR)
  SET(DOKAN_INC_DIR ${DOKAN_INC_DIR} CACHE PATH "Path to Dokan include directory" FORCE)
ENDIF()
FIND_PATH(Dokan_INCLUDE_DIR dokan.h PATHS ${DOKAN_INC_DIR})
IF(NOT Dokan_INCLUDE_DIR)
  SET(ERROR_MESSAGE "\nCould not find Dokan.  NO DOKAN.H - ")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}If Dokan is already installed, run:\n")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}${ERROR_MESSAGE_CMAKE_PATH} -DDOKAN_INC_DIR=<Path to Dokan include directory>")
  MESSAGE(FATAL_ERROR "${ERROR_MESSAGE}")
ENDIF()
