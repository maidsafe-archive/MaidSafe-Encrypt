...
IF(BREAKPAD_LIB_DIR)
  SET(BREAKPAD_LIB_DIR ${BREAKPAD_LIB_DIR} CACHE PATH "Path to Breakpad library directory" FORCE)
ENDIF()
IF(BREAKPAD_INC_DIR)
  SET(BREAKPAD_INC_DIR ${BREAKPAD_INC_DIR} CACHE PATH "Path to Breakpad include directory" FORCE)
ENDIF()
IF(BREAKPAD_ROOT_DIR)
  SET(BREAKPAD_ROOT_DIR ${BREAKPAD_ROOT_DIR} CACHE PATH "Path to Breakpad root directory" FORCE)
...
IF(NOT Breakpad_LIBRARY_RELEASE)
  ...
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}${ERROR_MESSAGE_CMAKE_PATH} -DBREAKPAD_LIB_DIR=<Path to Breakpad lib directory> and/or")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}\n${ERROR_MESSAGE_CMAKE_PATH} -DBREAKPAD_ROOT_DIR=<Path to Breakpad root directory>")
...
IF(NOT Breakpad_INCLUDE_DIR)
  ...
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}You can download it at http://code.google.com/p/google-breakpad\n")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}If Google Breakpad is already installed, run:\n")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}${ERROR_MESSAGE_CMAKE_PATH} -DBREAKPAD_INC_DIR=<Path to Breakpad include directory> and/or")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}\n${ERROR_MESSAGE_CMAKE_PATH} -DBREAKPAD_ROOT_DIR=<Path to Breakpad root directory>")
  MESSAGE(FATAL_ERROR "${ERROR_MESSAGE}")
ENDIF()
