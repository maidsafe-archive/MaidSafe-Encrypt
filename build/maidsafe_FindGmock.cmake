...
ENDIF()
IF(GMOCK_INC_DIR)
  SET(GMOCK_INC_DIR ${GMOCK_INC_DIR} CACHE INTERNAL "Path to GoogleMock include directory" FORCE)
ENDIF()
IF(GMOCK_ROOT_DIR)
  SET(GMOCK_ROOT_DIR ${GMOCK_ROOT_DIR} CACHE INTERNAL "Path to GoogleMock root directory" FORCE)
ENDIF()
...
IF(NOT Gmock_INCLUDE_DIR)
  ...
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}You can download it at http://code.google.com/p/googlemock\n")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}If Google Mock is already installed, run:\n")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}cmake ../.. -DGMOCK_INC_DIR=<Path to gmock include directory> and/or")
  SET(ERROR_MESSAGE "${ERROR_MESSAGE}\ncmake ../.. -DGMOCK_ROOT_DIR=<Path to gmock root directory>")
  MESSAGE(FATAL_ERROR "${ERROR_MESSAGE}")
ENDIF()
